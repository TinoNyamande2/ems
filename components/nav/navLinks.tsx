...
export const NavLinks = () => {
    ...
    const [organisationid, setOrganisationid] = useState(session?.user?.organisationid);
        ...
        <List component="nav">
            {session && (
                <>
                    ...
                    { session.user?.role === 'admin' && (
                        <ListItemButton onClick={() => handleRedirect(`leave-applications/${session?.user?.name}/approve`)}>
                            <ListItemIcon>
                                <ApprovalIcon />
                            </ListItemIcon>
                    ...
                    { session.user?.role === 'admin' && (
                        <ListItemButton onClick={() => handleRedirect(`leave-applications/${session?.user?.name}/reports`)}>
                            <ListItemIcon>
                                <LibraryBooksIcon />
                            </ListItemIcon>
