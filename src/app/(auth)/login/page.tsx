  ...
  return (
    <ThemeProvider theme={defaultTheme}>
      <Container component="main" maxWidth="xs">
        ...
        {isLoadingOpen ? (
          <CircularProgressSpinner message={loadingMessage} />
        ) : (
          <>
            <CssBaseline />
            <Box sx={{ marginTop: 8, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              ...
              <Box sx={{ mt: 1 }}>
                <Box>
                  ...
                  />
                  {!passwordModalOpen && formErrors.email && (
                    <Typography sx={{ color: "red", fontSize: "0.8em" }}>{formErrors.email}</Typography>
                  )}
                </Box>
                <Box>
                  <TextField
                    ...
                    onChange={handleChange}
                  />
                  {!passwordModalOpen && formErrors.password && (
                    <Typography sx={{ color: "red", fontSize: "0.8em" }}>{formErrors.password}</Typography>
                  )}
                </Box>
                <FormControlLabel
