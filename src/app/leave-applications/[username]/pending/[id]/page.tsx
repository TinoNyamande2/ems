...
export default function Page({ params }: { params: { id: string } }) {
    ...
    const onDelete = async () => {
        ...
        try {
            ...
            setTimeout(() => {
                router.push(`/leave-applications/${name}/pending`);
            }, 3000);
        } catch (error) {
        ...
        <div className="max-w-md mx-auto mt-8">
            ...
            {application && <div>
                ...
                <div style={{ display: "flex", flexDirection: "row" }} className='mb-4'>
                    ...
                    <Button sx={{ backgroundColor: "orange", color: "white" }} fullWidth><Link href={`/leave-applications/${name}/pending`}>Cancel</Link></Button>
                </div>
            </div>}
