...
export default function Page({ params }: { params: { id: string } }) {
    ...
    return (
        <Box>
            ...
            <Box>
                {user && <PerformanceSummaryForUserPerProject timePeriod={timePeriod} startDate={startDateFilter} endDate={endDateFilter} username={user.useremail} organisation={user.organisationid} project={id} />
            }
            </Box>
        </Box>
    )
